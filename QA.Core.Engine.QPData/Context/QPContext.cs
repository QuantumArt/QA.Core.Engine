...
namespace QA.Core.Engine.QPData
{
	...
	public partial class QPCulture : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _ChangeCultureLabel;

		private string _CultureSelectionTitle;
    ...
    partial void OnChangeCultureLabelChanging(string value);
    partial void OnChangeCultureLabelChanged();
    partial void OnCultureSelectionTitleChanging(string value);
    partial void OnCultureSelectionTitleChanged();
    #endregion
		...
		public string ChangeCultureLabel
		{
			get
			{
				return this._ChangeCultureLabel;
			}
			set
			{
				if ((this._ChangeCultureLabel != value))
				{
					this.OnChangeCultureLabelChanging(value);
					this.SendPropertyChanging();
					this._ChangeCultureLabel = value;
					this.SendPropertyChanged("ChangeCultureLabel");
					this.OnChangeCultureLabelChanged();
				}
			}
		}

		public string CultureSelectionTitle
		{
			get
			{
				return this._CultureSelectionTitle;
			}
			set
			{
				if ((this._CultureSelectionTitle != value))
				{
					this.OnCultureSelectionTitleChanging(value);
					this.SendPropertyChanging();
					this._CultureSelectionTitle = value;
					this.SendPropertyChanged("CultureSelectionTitle");
					this.OnCultureSelectionTitleChanged();
				}
			}
		}
